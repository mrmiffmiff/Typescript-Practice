...
// Can make generic constraints when we have some knowledge about capabilities used type will have...
// take loggingIdentity but to fully genericize without erroring, must prove length is present
...
function getProperty<Type, Key extends keyof Type>(obj: Type, key: Key) { // will get to keyof later
    return obj[key];
}
